...
@section('page-title', 'Statistik Transaksi')
@section('page-subtitle', 'Jumlah transaksi tukar buku')
@section('content')
<div class="flex flex-col gap-5">
    ...
    <div class="relative overflow-hidden rounded-xl bg-white border border-neutral-200">
        ...
        <div class="p-4 flex flex-wrap items-end justify-between gap-3">
            @include('admin.statistik._filter-statistik', ['routeName' => 'admin.statistik.transaksi'])

            <a href="{{ route('admin.statistik.transaksi.export', request()->only(['tahun', 'bulan'])) }}"
                title="Export Excel"
