<div id="modalEdit" class="fixed inset-0 z-50 hidden items-center justify-center p-4">
    ...
    <div class="relative bg-white rounded-2xl shadow-xl w-full max-w-2xl overflow-hidden">
        ...
        <div class="flex items-center justify-between px-8 pt-6 pb-5 border-b border-neutral-100">
            ...
            <button onclick="closeEdit()" class="p-2 rounded-lg text-neutral-400 hover:text-neutral-600 hover:bg-neutral-100 transition-colors">
        ...
        <div class="flex items-center justify-between px-8 py-5 border-t border-neutral-100 bg-neutral-50">
            ...
            <div class="ml-auto flex gap-2">
                ...
                <button id="editBtnSimpan" onclick="updateTransaksi()"
                        class="hidden text-sm font-medium px-5 py-2.5 rounded-lg bg-warning-500 text-white hover:bg-warning-600 transition-colors">
                    Simpan Perubahan
                </button>
            </div>
        </div>
