<div class="step-content-{{ $prefix }} hidden" data-step="3">
    ...
    <div class="mb-4">
        ...
        <div class="relative">
            ...
            <input type="text" id="{{ $prefix }}_cariBukuKeluar"
            ...
            <div id="{{ $prefix }}_cariBukuKeluarResults"
        ...
        <p id="{{ $prefix }}_cariBukuKeluarInfo" class="text-xs mt-1.5"></p>
    </div>

    <div id="{{ $prefix }}_bukuKeluarResult" class="hidden mb-4">
        <div class="p-4 rounded-xl border border-success-200 bg-success-50 flex items-start gap-3">
            ...
            <div class="flex-1 min-w-0">
                <p class="text-sm font-semibold text-success-800" id="{{ $prefix }}_bukuKeluarJudul"></p>
                <p class="text-xs text-success-600 mt-0.5" id="{{ $prefix }}_bukuKeluarPengarang"></p>
                <p class="text-xs text-success-600 mt-0.5">
                    Stok: <span id="{{ $prefix }}_bukuKeluarStok" class="font-semibold"></span>
                    &nbsp;·&nbsp;
                    Paket: <span id="{{ $prefix }}_bukuKeluarPaket" class="font-semibold"></span>
                    &nbsp;·&nbsp;
                    Lokasi: <span id="{{ $prefix }}_bukuKeluarLokasi" class="font-semibold"></span>
                </p>
            </div>
            <button type="button" onclick="resetBukuKeluar('{{ $prefix }}')"
        ...
        <input type="hidden" id="{{ $prefix }}_bukuKeluarId"/>
    </div>

    <div id="{{ $prefix }}_bukuKeluarEmpty">
