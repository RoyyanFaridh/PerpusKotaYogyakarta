        ...
        <form method="POST" action="{{ route('admin.member.store') }}" class="px-6 py-5 flex flex-col gap-4">
            ...
            <div class="flex flex-col gap-1.5">
                ...
                <input
                    ...
                    class="w-full text-sm px-3.5 py-2.5 rounded-lg border {{ $errors->has('no_telp') ? 'border-danger-400 bg-danger-50' : 'border-neutral-200 bg-white' }} text-neutral-800 placeholder-neutral-300 focus:outline-none focus:ring-2 focus:ring-primary-300 focus:border-primary-400 transition"
                >
                @error('no_telp')
