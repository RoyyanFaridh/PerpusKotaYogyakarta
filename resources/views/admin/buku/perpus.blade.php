...
@section('page-subtitle', 'Koleksi buku asli perpustakaan')
...
<div class="flex flex-col gap-4">
    ...
    <x-admin.page-header
        ...
        :stats="[
            ...
            ['label' => 'Habis',    'value' => $stats['habis'],    'color' => 'text-danger-700'],
            ['label' => 'Kategori', 'value' => $stats['kategori'], 'color' => 'text-primary-700'],
        ]"
        :filters="[
            [
                'name'        => 'kategori',
                ...
                <tbody class="divide-y divide-neutral-50">
                    @forelse ($bukus as $buku)
                        <tr class="hover:bg-neutral-50 transition-colors">
                            ...
                            <td class="px-5 py-3.5 text-xs text-neutral-500 whitespace-nowrap">{{ $buku->lokasi?->nama_lokasi ?? '-' }}</td>
                            <td class="px-5 py-3.5">
                        ...
                        <tr>
                            <td colspan="7" class="px-5 py-12 text-center">
                                <div class="flex flex-col items-center gap-2">
                                    ...
                                    <p class="text-sm font-medium text-neutral-500">Belum ada buku perpustakaan</p>
