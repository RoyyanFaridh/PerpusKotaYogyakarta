        ...
        <div id="modal-konten" class="hidden">
            ...
            <div class="flex gap-5 p-6 pb-4">
                <div id="modal-cover-wrap"
                    ...
                    <svg id="modal-cover-placeholder" class="w-10 h-10 text-primary-200 stroke-current fill-none" viewBox="0 0 24 24" stroke-width="1.3">
                        <rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 21V9"/>
                    </svg>
                </div>
                ...
                <div class="flex-1 min-w-0 pt-1">
                    ...
                    <h2 id="modal-judul" class="font-extrabold text-primary-900 leading-snug mb-1"
                        style="font-size: clamp(1rem, 3vw, 1.3rem);"></h2>
                    <p id="modal-pengarang" class="text-sm font-medium text-neutral-500 mb-3"></p>

                    {{-- Meta row --}}
                    <div class="flex flex-wrap gap-x-4 gap-y-1.5">
                        <div id="modal-penerbit-wrap" class="hidden flex items-center gap-1.5 text-xs text-neutral-400">
                        ...
                        <div id="modal-tahun-wrap" class="hidden flex items-center gap-1.5 text-xs text-neutral-400">
                            <svg class="w-3.5 h-3.5 shrink-0 stroke-current fill-none" viewBox="0 0 24 24" stroke-width="2" stroke-linecap="round">
                                <rect x="3" y="4" width="18" height="18" rx="2"/><path d="M16 2v4M8 2v4M3 10h18"/>
                            </svg>
                            <span id="modal-tahun"></span>
                        </div>
                        <div id="modal-tempat-wrap" class="hidden flex items-center gap-1.5 text-xs text-neutral-400">
                            <svg class="w-3.5 h-3.5 shrink-0 stroke-current fill-none" viewBox="0 0 24 24" stroke-width="2" stroke-linecap="round">
                                <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z"/>
                                <circle cx="12" cy="9" r="2.5"/>
                            </svg>
                        ...
                        <div id="modal-isbn-wrap" class="hidden flex items-center gap-1.5 text-xs text-neutral-400">
                            <svg class="w-3.5 h-3.5 shrink-0 stroke-current fill-none" viewBox="0 0 24 24" stroke-width="2" stroke-linecap="round">
...
(function () {
    ...
    function isiModal(b) {
        ...
        // Meta (tampil hanya kalau ada nilai)
