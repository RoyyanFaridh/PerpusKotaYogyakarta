...
<div id="modalEditUser-<?php echo e($user->id); ?>"
     class="hidden fixed inset-0 z-50 items-center justify-center bg-black/40 backdrop-blur-sm p-4">

    <div class="absolute inset-0" onclick="tutupModalEditUser(<?php echo e($user->id); ?>)"></div>
    ...
    <div class="relative z-10 w-full max-w-lg rounded-2xl bg-white overflow-hidden shadow-xl max-h-[90vh] overflow-y-auto custom-scroll">
        ...
        <div class="flex items-center justify-between px-6 sm:px-8 pt-6 pb-5 border-b border-neutral-100 sticky top-0 bg-white z-20">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h2 class="text-base font-semibold text-neutral-800">Edit User — <?php echo e($user->nama); ?></h2>
                    <p class="text-sm text-neutral-400 mt-0.5">Ubah profil dan password</p>
                </div>
            </div>
            <button type="button" onclick="tutupModalEditUser(<?php echo e($user->id); ?>)"
        ...
        <form id="formEditUser-<?php echo e($user->id); ?>" method="POST"
              action="<?php echo e(route('admin.pengaturan.user.update', $user)); ?>"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div class="flex flex-col gap-1.5">
                    ...
                    <input type="text" name="nama" id="edit_nama_<?php echo e($user->id); ?>"
                        value="<?php echo e(old('nama', $user->nama)); ?>"
                        class="w-full text-sm px-3.5 py-2 rounded-lg border <?php echo e($errors->has('nama') ? 'border-danger-400 bg-danger-50' : 'border-neutral-200'); ?> text-neutral-800 placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition">
                    <p id="edit_err_nama_<?php echo e($user->id); ?>"
                    class="<?php echo e($errors->has('nama') ? '' : 'hidden'); ?> text-xs text-danger-500">
                        <?php echo e($errors->first('nama') ?: 'Nama wajib diisi.'); ?>
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <input type="text" name="username" id="edit_username_<?php echo e($user->id); ?>"
                        value="<?php echo e(old('username', $user->username)); ?>" placeholder="contoh.username"
                        class="w-full text-sm px-3.5 py-2 rounded-lg border <?php echo e($errors->has('username') ? 'border-danger-400 bg-danger-50' : 'border-neutral-200'); ?> text-neutral-800 placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition">
                    <p id="edit_err_username_<?php echo e($user->id); ?>"
                    class="<?php echo e($errors->has('username') ? '' : 'hidden'); ?> text-xs text-danger-500">
                        <?php echo e($errors->first('username') ?: 'Username wajib diisi.'); ?>
            ...
            <div class="flex flex-col gap-1.5">
                ...
                <input type="email" name="email" id="edit_email_<?php echo e($user->id); ?>"
                       value="<?php echo e(old('email', $user->email)); ?>" placeholder="contoh@email.com"
                       class="w-full text-sm px-3.5 py-2 rounded-lg border <?php echo e($errors->has('email') ? 'border-danger-400 bg-danger-50' : 'border-neutral-200'); ?> text-neutral-800 placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition">
                <p id="edit_err_email_<?php echo e($user->id); ?>"
                   class="<?php echo e($errors->has('email') ? '' : 'hidden'); ?> text-xs text-danger-500">
                    <?php echo e($errors->first('email') ?: 'Email wajib diisi.'); ?>
            ...
            <?php if(!$user->isSuperAdmin()): ?>
                <div class="flex flex-col gap-1.5">
                    ...
                    <select name="role"
                            class="w-full text-sm px-3.5 py-2 rounded-lg border <?php echo e($errors->has('role') ? 'border-danger-400 bg-danger-50' : 'border-neutral-200'); ?> text-neutral-800 focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition bg-white">
...
$message = $__bag->first($__errorArgs[0]); ?>
                        <p class="text-xs text-danger-500"><?php echo e($message); ?></p>
                    <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex flex-col gap-4">
                <div class="flex flex-col gap-1.5">
                    ...
                    <input type="password" name="password" id="edit_password_<?php echo e($user->id); ?>"
                           placeholder="Min. 8 karakter"
                           class="w-full text-sm px-3.5 py-2 rounded-lg border <?php echo e($errors->has('password') ? 'border-danger-400 bg-danger-50' : 'border-neutral-200'); ?> text-neutral-800 placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition">
                    <p id="edit_err_password_<?php echo e($user->id); ?>"
                       class="<?php echo e($errors->has('password') ? '' : 'hidden'); ?> text-xs text-danger-500">
                        <?php echo e($errors->first('password') ?: 'Password minimal 8 karakter.'); ?>
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <input type="password" name="password_confirmation"
                           id="edit_password_confirmation_<?php echo e($user->id); ?>"
                    ...
                    <p id="edit_err_password_confirmation_<?php echo e($user->id); ?>"
        ...
        <div class="flex items-center justify-end gap-2 px-6 sm:px-8 py-4 border-t border-neutral-100 bg-neutral-50 sticky bottom-0">
            ...
            <button type="button" onclick="submitEditUser(<?php echo e($user->id); ?>)"
...
<script>
    ...
    <?php if($errors->hasAny(['nama', 'username', 'email', 'role', 'password'])): ?>
        document.addEventListener('DOMContentLoaded', () => bukaModalEditUser(<?php echo e($user->id); ?>));
    <?php endif; ?>
</script><?php /**PATH C:\xampp\htdocs\rotateyourbook\resources\views/admin/pengaturan/modals/edit.blade.php ENDPATH**/ ?>