...
<head>
    ...
    <style>
        ...
        #sidebar-wrap { visibility: hidden; }
    </style>
    <script>
        (function() {
            ...
            /* PERBAIKAN 5: Langsung tampilkan sidebar setelah nilai diset */
...
<body class="font-sans bg-neutral-100 flex h-screen overflow-hidden custom-scroll">
        ...
        <header class="h-16 bg-white border-b border-neutral-200 flex items-center justify-between px-6 shrink-0 shadow-sm">
            ...
            <div class="flex items-center gap-3">
                ...
                <button
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4.5 h-4.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
        ...
        <div class="relative w-full max-w-sm rounded-xl bg-white border border-neutral-200 overflow-hidden shadow-lg">
            ...
            <div class="px-6 py-5 flex flex-col items-center gap-3 text-center">
                <div class="w-10 h-10 rounded-full bg-danger-50 flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-danger-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
    ...
    <script>
        function closeModalDenied() {
            const modal = document.getElementById('modalDenied');
            if (modal) modal.remove();
        }

        /* PERBAIKAN 4: ESC key untuk close modal */
        document.addEventListener('keydown', function(e) {
            if (e.key === 'Escape') closeModalDenied();
        });
    </script>
</body>
</html><?php /**PATH C:\xampp\htdocs\rotateyourbook\resources\views/layouts/admin.blade.php ENDPATH**/ ?>