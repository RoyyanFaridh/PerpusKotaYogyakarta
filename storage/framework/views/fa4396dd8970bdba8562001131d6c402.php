<div id="modalTambahUser"
    ...
    <div class="relative z-10 w-full max-w-lg rounded-2xl bg-white overflow-hidden shadow-xl">
        ...
        <form id="formTambahUser" method="POST" action="<?php echo e(route('admin.pengaturan.user.store')); ?>"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div class="flex flex-col gap-1.5">
                    ...
                    <input type="text" name="new_name" id="tambah_new_name"
                        value="<?php echo e(old('new_name')); ?>" placeholder="Nama lengkap"
                        class="w-full text-sm px-3.5 py-2 rounded-lg border <?php echo e($errors->has('new_name') ? 'border-danger-400 bg-danger-50' : 'border-neutral-200'); ?> text-neutral-800 placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition">
                    <p id="tambah_err_new_name" class="hidden text-xs text-danger-500">
                        <?php echo e($errors->first('new_name') ?: 'Nama wajib diisi.'); ?>
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <input type="text" name="new_username" id="tambah_new_username"
                        value="<?php echo e(old('new_username')); ?>" placeholder="username"
                        class="w-full text-sm px-3.5 py-2 rounded-lg border <?php echo e($errors->has('new_username') ? 'border-danger-400 bg-danger-50' : 'border-neutral-200'); ?> text-neutral-800 placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition">
                    <p id="tambah_err_new_username" class="hidden text-xs text-danger-500">
                        <?php echo e($errors->first('new_username') ?: 'Username wajib diisi.'); ?>
            ...
            <div class="flex flex-col gap-1.5">
                ...
                <input type="email" name="new_email" id="tambah_new_email"
                       value="<?php echo e(old('new_email')); ?>" placeholder="contoh@email.com"
                       class="w-full text-sm px-3.5 py-2 rounded-lg border <?php echo e($errors->has('new_email') ? 'border-danger-400 bg-danger-50' : 'border-neutral-200'); ?> text-neutral-800 placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition">
                <p id="tambah_err_new_email" class="hidden text-xs text-danger-500">
                    <?php echo e($errors->first('new_email') ?: 'Email wajib diisi.'); ?>
            ...
            <div class="flex flex-col gap-1.5">
                ...
                <input type="password" name="new_password" id="tambah_new_password"
                       ...
                       class="w-full text-sm px-3.5 py-2 rounded-lg border <?php echo e($errors->has('new_password') ? 'border-danger-400 bg-danger-50' : 'border-neutral-200'); ?> text-neutral-800 placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition">
                <p id="tambah_err_new_password" class="hidden text-xs text-danger-500">
                    <?php echo e($errors->first('new_password') ?: 'Password wajib diisi.'); ?>
            ...
            <div class="flex flex-col gap-1.5">
                ...
                <select name="new_role" id="tambah_new_role"
                        class="w-full text-sm px-3.5 py-2 rounded-lg border <?php echo e($errors->has('new_role') ? 'border-danger-400 bg-danger-50' : 'border-neutral-200'); ?> text-neutral-800 focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition bg-white">
                    <option value="admin"      <?php echo e(old('new_role', 'admin') === 'admin'      ? 'selected' : ''); ?>>Admin</option>
                    <option value="superadmin" <?php echo e(old('new_role') === 'superadmin' ? 'selected' : ''); ?>>Superadmin</option>
                </select>
                <p class="text-xs text-neutral-400">Superadmin memiliki semua akses tanpa perlu diatur permission-nya.</p>
                <?php $__errorArgs = ['new_role'];
...
<script>
    ...
    <?php if($errors->hasAny(['new_name', 'new_email', 'new_password', 'new_role'])): ?>
        document.addEventListener('DOMContentLoaded', () => {
            bukaModalUser();
            <?php if($errors->has('new_name')): ?>
                setErrorTambahUser('tambah_new_name', 'tambah_err_new_name', true, '<?php echo e($errors->first('new_name')); ?>');
            <?php endif; ?>
            <?php if($errors->has('new_email')): ?>
                setErrorTambahUser('tambah_new_email', 'tambah_err_new_email', true, '<?php echo e($errors->first('new_email')); ?>');
            <?php endif; ?>
            <?php if($errors->has('new_password')): ?>
                setErrorTambahUser('tambah_new_password', 'tambah_err_new_password', true, '<?php echo e($errors->first('new_password')); ?>');
            <?php endif; ?>
        });
    <?php endif; ?>
</script><?php /**PATH C:\xampp\htdocs\rotateyourbook\resources\views/admin/pengaturan/modals/create.blade.php ENDPATH**/ ?>