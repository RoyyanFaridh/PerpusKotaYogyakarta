        ...
        <form id="formAktifkanPaket" method="POST" action="" class="px-6 pb-6 pt-4 flex flex-col gap-4">
            ...
            <div class="flex flex-col gap-1.5">
                ...
                <select id="aktifkanLokasiId" name="lokasi_id" required
                    ...
                    <?php $__currentLoopData = \App\Models\Lokasi::aktif()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lokasi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
</div><?php /**PATH C:\xampp\htdocs\rotateyourbook\resources\views/admin/paket/aktifkan.blade.php ENDPATH**/ ?>