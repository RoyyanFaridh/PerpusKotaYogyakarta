<div id="modalBuatPaket"
    ...
    <div class="relative z-10 w-full max-w-md rounded-2xl bg-white overflow-hidden shadow-xl">
        ...
        <form method="POST" action="<?php echo e(route('admin.paket.store')); ?>" class="px-6 pb-6 pt-4 flex flex-col gap-4">
            <?php echo csrf_field(); ?>
...
</div><?php /**PATH C:\xampp\htdocs\rotateyourbook\resources\views/admin/paket/create.blade.php ENDPATH**/ ?>