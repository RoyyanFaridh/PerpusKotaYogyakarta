<div class="step-content-<?php echo e($prefix); ?> hidden" data-step="3">
    ...
    <div class="mb-4">
        ...
        <div class="flex gap-2">
            <div class="relative flex-1">
                ...
                <input type="text" id="<?php echo e($prefix); ?>_cariBukuDiterima"
            ...
            <button type="button" onclick="cariBukuDiterima('<?php echo e($prefix); ?>')"
        ...
        <div id="<?php echo e($prefix); ?>_cariBukuDiterimaResults"
             class="hidden mt-2 rounded-lg border border-neutral-200 bg-white overflow-hidden shadow-sm max-h-44 overflow-y-auto">
        </div>
        <p id="<?php echo e($prefix); ?>_cariBukuDiterimaInfo" class="text-xs mt-1.5"></p>
    </div>

    <div id="<?php echo e($prefix); ?>_bukuDiterimaResult" class="hidden mb-4">
        <div class="p-4 rounded-xl border border-success-200 bg-success-50 flex items-start gap-3">
            ...
            <div class="flex-1 min-w-0">
                <p class="text-sm font-semibold text-success-800" id="<?php echo e($prefix); ?>_bukuDiterimaJudul"></p>
                <p class="text-xs text-success-600 mt-0.5" id="<?php echo e($prefix); ?>_bukuDiterimaPengarang"></p>
                <p class="text-xs text-success-600 mt-0.5">
                    Stok: <span id="<?php echo e($prefix); ?>_bukuDiterimaStok" class="font-semibold"></span>
                    &nbsp;·&nbsp;
                    Paket: <span id="<?php echo e($prefix); ?>_bukuDiterimaPaket" class="font-semibold"></span>
                    &nbsp;·&nbsp;
                    Lokasi: <span id="<?php echo e($prefix); ?>_bukuDiterimaLokasi" class="font-semibold"></span>
                </p>
            </div>
            <button type="button" onclick="resetBukuDiterima('<?php echo e($prefix); ?>')"
        ...
        <input type="hidden" id="<?php echo e($prefix); ?>_bukuDiterimaId"/>
    </div>

    <div id="<?php echo e($prefix); ?>_bukuDiterimaEmpty">
...
</div><?php /**PATH C:\xampp\htdocs\rotateyourbook\resources\views/admin/transaksi/_step-diterima.blade.php ENDPATH**/ ?>