<div class="step-content-<?php echo e($prefix); ?> hidden" data-step="<?php echo e(2 + ($offset ?? 0)); ?>">
    ...
    <div class="mb-5">
        ...
        <select id="<?php echo e($prefix); ?>_paketMasukId"
    ...
    <div class="mb-4">
        ...
        <div class="relative">
            ...
            <input type="text" id="<?php echo e($prefix); ?>_cariMasuk"
            ...
            <div id="<?php echo e($prefix); ?>_cariMasukResults"
        ...
        <p id="<?php echo e($prefix); ?>_cariMasukInfo" class="text-xs text-neutral-400 mt-1.5"></p>
    </div>
    ...
    <div class="space-y-4">
        <div class="grid grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" id="<?php echo e($prefix); ?>_masukJudul" placeholder="Judul buku"
            ...
            <div>
                ...
                <input type="text" id="<?php echo e($prefix); ?>_masukPengarang" placeholder="Nama pengarang"
                       class="w-full px-3.5 py-2.5 text-sm rounded-lg border border-neutral-200 focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition"/>
            </div>
        </div>
        ...
        <div>
            ...
            <input type="text" id="<?php echo e($prefix); ?>_isbnMasuk"
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" id="<?php echo e($prefix); ?>_masukPenerbit" placeholder="Nama penerbit"
                       class="w-full px-3.5 py-2.5 text-sm rounded-lg border border-neutral-200 focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition"/>
            </div>
            <div>
                <label class="block text-sm font-medium text-neutral-600 mb-1.5">
                ...
                <select id="<?php echo e($prefix); ?>_masukKategori"
                        class="w-full px-3.5 py-2.5 text-sm rounded-lg border border-neutral-200 focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition bg-white">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                ...
                <input type="number" id="<?php echo e($prefix); ?>_masukTahunTerbit"
                       placeholder="cth. 2021" min="1900" max="<?php echo e(date('Y')); ?>"
                       class="w-full px-3.5 py-2.5 text-sm rounded-lg border border-neutral-200 focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition"/>
            </div>
            <div>
                <label class="block text-sm font-medium text-neutral-600 mb-1.5">
                ...
                <input type="text" id="<?php echo e($prefix); ?>_masukTempatTerbit" placeholder="cth. Jakarta"
                       class="w-full px-3.5 py-2.5 text-sm rounded-lg border border-neutral-200 focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition"/>
            </div>
        </div>
        ...
        <div>
            ...
            <textarea id="<?php echo e($prefix); ?>_masukDeskripsi" rows="2"
...
</div><?php /**PATH D:\Perkuliahan Duniawi\MAGANG GES\PerpusKotaYogyakarta\resources\views/admin/transaksi/_step-masuk.blade.php ENDPATH**/ ?>