...
<div id="modalToggleAktifUser-<?php echo e($user->id); ?>"
     class="hidden fixed inset-0 z-50 items-center justify-center bg-black/40 backdrop-blur-sm p-4">

    <div class="absolute inset-0" onclick="tutupModalToggleAktifUser(<?php echo e($user->id); ?>)"></div>

    <div class="relative z-10 w-full max-w-md rounded-2xl bg-white overflow-hidden shadow-xl">
        <div class="absolute top-0 left-0 right-0 h-0.5 <?php echo e($user->is_active ? 'bg-warning-400' : 'bg-success-400'); ?>"></div>
        ...
        <div class="flex items-center justify-between px-6 sm:px-8 pt-6 pb-5 border-b border-neutral-100">
            <div>
                ...
                <p class="text-sm text-neutral-400 mt-0.5">
                    <?php echo e($user->is_active ? 'Admin tidak bisa login setelah dinonaktifkan' : 'Admin bisa login kembali setelah diaktifkan'); ?>

                </p>
            </div>
            <button type="button" onclick="tutupModalToggleAktifUser(<?php echo e($user->id); ?>)"
        ...
        <div class="px-6 sm:px-8 py-5 flex flex-col gap-4">
            ...
            <div class="flex items-center gap-3 p-3.5 rounded-lg border border-neutral-100 bg-neutral-50">
                ...
                <div>
                    <p class="text-sm font-semibold text-neutral-800"><?php echo e($user->nama); ?></p>
                    <p class="text-xs text-neutral-400 mt-0.5"><?php echo e($user->email ?? 'Tidak ada email'); ?></p>
                    <p class="text-xs text-neutral-400">
                        <?php echo e($user->isSuperAdmin() ? 'Superadmin' : 'Admin'); ?>

                        · Dibuat <?php echo e($user->created_at?->format('d M Y')); ?>
        ...
        <form method="POST" action="<?php echo e(route('admin.pengaturan.user.toggle-aktif', $user)); ?>">
            <?php echo csrf_field(); ?>
...
</script><?php /**PATH C:\xampp\htdocs\rotateyourbook\resources\views/admin/pengaturan/modals/destroy.blade.php ENDPATH**/ ?>