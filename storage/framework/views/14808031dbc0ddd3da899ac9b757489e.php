<?php if(!$user->isSuperAdmin() && auth()->user()->isSuperAdmin()): ?>
    <tr id="permission-row-<?php echo e($user->id); ?>" class="hidden">
            ...
            <div class="rounded-2xl border border-neutral-100 bg-neutral-50 overflow-hidden">
                <div class="px-5 py-3.5 border-b border-neutral-100 flex items-center justify-between bg-white">
                    <div class="flex items-center gap-2">
                        ...
                        <p class="text-sm font-semibold text-neutral-700">Hak Akses — <?php echo e($user->nama); ?></p>
                    </div>
                    <button type="button" onclick="togglePermission(<?php echo e($user->id); ?>)"
                ...
                <form method="POST" action="<?php echo e(route('admin.pengaturan.user.permissions', $user)); ?>"
                      class="px-5 py-5">
                    <?php echo csrf_field(); ?>
                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                        <?php $__currentLoopData = $allPermissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $modul => $permissions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex flex-col gap-2">
                                <p class="text-xs font-semibold text-neutral-400 uppercase tracking-wide"><?php echo e($modul); ?></p>
                                <div class="flex flex-col gap-1">
                                    <?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        ?>
                                        <label class="flex items-center gap-2 px-2.5 py-1.5 rounded-lg bg-white border <?php echo e($checked ? 'border-primary-200 text-primary-700' : 'border-neutral-100 text-neutral-500'); ?> cursor-pointer hover:border-primary-200 hover:text-primary-700 transition-colors">
                                            <input type="checkbox"
                                                   name="permissions[]"
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\rotateyourbook\resources\views/admin/pengaturan/partials/accordion-permission.blade.php ENDPATH**/ ?>