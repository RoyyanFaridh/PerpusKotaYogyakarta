<div id="modalTambahLokasi"
    ...
    <div class="relative z-10 w-full max-w-md rounded-2xl bg-white overflow-hidden shadow-xl">
        ...
        <form id="formTambahLokasi" method="POST" action="<?php echo e(route('admin.lokasi.store')); ?>"
            ...
            <div class="flex flex-col gap-1.5">
                ...
                <input type="text" id="nama_lokasi" name="nama_lokasi"
                       value="<?php echo e(old('nama_lokasi')); ?>" placeholder="Contoh: Perpustakaan Pusat"
                       class="w-full text-sm px-3.5 py-2.5 rounded-lg border <?php echo e($errors->has('nama_lokasi') ? 'border-danger-400 bg-danger-50' : 'border-neutral-200'); ?> text-neutral-800 placeholder-neutral-300 focus:outline-none focus:ring-2 focus:ring-primary-300 focus:border-primary-400 transition"/>
                <?php $__errorArgs = ['nama_lokasi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                    <p class="text-[0.68rem] text-danger-500"><?php echo e($message); ?></p>
                <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex flex-col gap-1.5">
                ...
                <textarea id="alamat" name="alamat" rows="3"
                          ...
                          class="w-full text-sm px-3.5 py-2.5 rounded-lg border <?php echo e($errors->has('alamat') ? 'border-danger-400 bg-danger-50' : 'border-neutral-200'); ?> text-neutral-800 placeholder-neutral-300 focus:outline-none focus:ring-2 focus:ring-primary-300 focus:border-primary-400 transition resize-none"><?php echo e(old('alamat')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex flex-col gap-1.5">
                ...
                <input type="text" id="no_telp" name="no_telp"
                       value="<?php echo e(old('no_telp')); ?>" maxlength="15" placeholder="Contoh: 0274123456"
                       class="w-full text-sm px-3.5 py-2.5 rounded-lg border <?php echo e($errors->has('no_telp') ? 'border-danger-400 bg-danger-50' : 'border-neutral-200'); ?> text-neutral-800 placeholder-neutral-300 focus:outline-none focus:ring-2 focus:ring-primary-300 focus:border-primary-400 transition"/>
...
</script><?php /**PATH C:\xampp\htdocs\rotateyourbook\resources\views/admin/lokasi/create.blade.php ENDPATH**/ ?>