...
<?php $__env->startSection('page-subtitle', 'Kelola data member perpustakaan'); ?>
    ...
    <div class="relative overflow-hidden rounded-xl bg-white border border-neutral-200">
        ...
        <div class="flex items-center justify-between gap-4 px-5 pt-5 pb-4 border-b border-neutral-100">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-neutral-400 leading-tight"><?php echo e($members->total()); ?> member terdaftar</p>
                </div>
            </div>
            <div class="flex items-center gap-2 shrink-0">
                <a href="<?php echo e(route('admin.member.export')); ?>"
                title="Export Excel"
        ...
        <div class="grid grid-cols-1 border-b border-neutral-100">
            <div class="px-5 py-3.5 flex flex-col gap-0.5">
                ...
                <span class="text-2xl font-semibold tabular-nums text-neutral-800"><?php echo e($totalMember); ?></span>
            </div>
        </div>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-neutral-50 transition-colors">
                            <td class="px-5 py-3.5">
                                <p class="text-xs font-semibold text-neutral-800"><?php echo e($member->nama); ?></p>
                            </td>
                            ...
                            <td class="px-4 py-3.5 text-center">
                                <span class="text-xs font-mono font-semibold text-neutral-800"><?php echo e($member->no_telp); ?></span>
                            </td>
                            ...
                            <td class="px-4 py-3.5">
                                <div class="flex items-center justify-center gap-1.5">
                                    <button type="button"
                                            onclick="bukaModalEdit(<?php echo e(json_encode([
                                                'id'      => $member->id,
...
<?php endif; ?>
                                    ...
                                    <button type="button"
                                            onclick="bukaModalHapusMember(
                                                '<?php echo e(route('admin.member.destroy', $member)); ?>',
                                                '<?php echo e(addslashes($member->nama)); ?>'
                                            )"
...
<?php echo $__env->make('admin.member.create', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php echo $__env->make('admin.member.edit', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php echo $__env->make('admin.member.destroy', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rotateyourbook\resources\views/admin/member/index.blade.php ENDPATH**/ ?>