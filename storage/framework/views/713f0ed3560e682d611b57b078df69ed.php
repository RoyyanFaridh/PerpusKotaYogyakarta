...
<?php $__env->startSection('title', 'Statistik Buku'); ?>
<?php $__env->startSection('page-title', 'Statistik Buku'); ?>
<?php $__env->startSection('page-subtitle', 'Jumlah buku baru ditambahkan'); ?>
...
<div class="flex flex-col gap-5">
    ...
    <div class="relative overflow-hidden rounded-xl bg-white border border-neutral-200">
        ...
        <div class="p-4 flex flex-wrap items-end justify-between gap-3">
            <?php echo $__env->make('admin.statistik._filter-statistik', ['routeName' => 'admin.statistik.buku'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

            <a href="<?php echo e(route('admin.statistik.buku.export', request()->only(['tahun', 'bulan']))); ?>"
                title="Export Excel"
    ...
    <div class="relative overflow-hidden rounded-xl bg-white border border-neutral-200">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3">
            <div class="px-5 py-3.5 flex flex-col gap-0.5">
                <span class="text-xs text-neutral-400 font-medium">Total Buku Baru</span>
    ...
    (function () {
        ...
        new Chart(ctx, {
            ...
            data: {
                labels: labels,
                datasets: [{
                    label: mode === 'harian' ? 'Buku baru per hari' : 'Buku baru per bulan',
                    data: values,
                    fill: true,
            ...
            options: {
                ...
                scales: {
                    ...
                    y: {
                        beginAtZero: true,
                        ticks: { precision: 0 },
                        title: { display: true, text: 'Jumlah Buku' }
                    }
                }
            }
        });
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Perkuliahan Duniawi\MAGANG GES\PerpusKotaYogyakarta\resources\views/admin/statistik/buku.blade.php ENDPATH**/ ?>