...
<head>
    ...
    <title>SIROBY - Sistem Rotate Your Book</title>
    ...
    <style>
        ...
        /* Katalog section: hidden by default, shown when search returns results */
...
<body class="font-sans bg-primary-50 text-primary-900 min-h-screen overflow-x-hidden relative custom-scroll">
    ...
    <?php echo $__env->make('components.home.hero-search', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('components.home.katalog-pencarian', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('components.home.buku-terbaru', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('components.home.stats-strip', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('components.home.kegiatan', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('components.home.footer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    
    <?php echo $__env->make('components.home.modal-detail-buku', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                ...
                <div class="book-card-stagger-${Math.min(i + 1, 12)} flex flex-col bg-white border border-primary-100 rounded-xl overflow-hidden cursor-pointer transition-all duration-200 hover:-translate-y-1 hover:border-primary-200 snap-start shrink-0 w-44 sm:w-52"
                    ...
                    ${buku.cover_url
                        ? `<div class="w-full bg-primary-50/60 flex items-center justify-center" style="height:160px;">
                                <img src="${escHtml(buku.cover_url)}"
                                     alt="Cover ${escHtml(buku.judul)}"
                    ...
                    <div class="flex flex-col p-3 flex-1">
                        <div class="flex items-start justify-between gap-1 mb-2">
                            ...
                            <span class="text-[0.65rem] font-medium text-neutral-400 shrink-0">
                                ${escHtml(String(buku.tahun_terbit ?? ''))}
                            </span>
                        </div>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        const closestIndex = <?php echo e($closestIndex ?? 0); ?>;
...
</html><?php /**PATH D:\Perkuliahan Duniawi\MAGANG GES\PerpusKotaYogyakarta\resources\views/welcome.blade.php ENDPATH**/ ?>