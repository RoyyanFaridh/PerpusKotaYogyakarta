<div id="modalTambahMember"
    ...
    <div class="relative z-10 w-full max-w-md rounded-2xl bg-white overflow-hidden shadow-xl">
        ...
        <form id="formTambahMember" method="POST" action="<?php echo e(route('admin.member.store')); ?>"
...
</script><?php /**PATH C:\xampp\htdocs\rotateyourbook\resources\views/admin/member/create.blade.php ENDPATH**/ ?>