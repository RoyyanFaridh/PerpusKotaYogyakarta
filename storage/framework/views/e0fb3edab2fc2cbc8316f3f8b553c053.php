<div id="modalEdit" class="fixed inset-0 z-50 hidden items-center justify-center p-4">
    ...
    <div class="relative bg-white rounded-2xl shadow-xl w-full max-w-2xl overflow-hidden">
        ...
        <?php echo $__env->make('admin.transaksi._step-indicator', ['prefix' => 'edit'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        <div class="px-6 sm:px-8 py-6 min-h-96">
            <?php echo $__env->make('admin.transaksi._step-member',     ['prefix' => 'edit'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('admin.transaksi._step-masuk', ['prefix' => 'edit'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('admin.transaksi._step-keluar',   ['prefix' => 'edit'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('admin.transaksi._step-konfirmasi', ['prefix' => 'edit'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
...
</div><?php /**PATH D:\Perkuliahan Duniawi\MAGANG GES\PerpusKotaYogyakarta\resources\views/admin/transaksi/edit.blade.php ENDPATH**/ ?>