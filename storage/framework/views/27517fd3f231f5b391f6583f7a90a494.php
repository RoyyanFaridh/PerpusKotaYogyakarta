<div id="modalCreate" class="fixed inset-0 z-50 hidden items-center justify-center p-4">
    ...
    <div class="relative bg-white rounded-2xl shadow-xl w-full max-w-2xl overflow-hidden">
        ...
        <?php echo $__env->make('admin.transaksi._step-indicator', ['prefix' => 'create'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        
        <div class="px-6 sm:px-8 py-6 overflow-y-auto max-h-[55vh]">
            <input type="hidden" id="create_paketId"   value="<?php echo e($paketUser?->id ?? ''); ?>"/>
            <input type="hidden" id="create_paketNama" value="<?php echo e($paketUser?->nama ?? ''); ?>"/>
            <input type="hidden" id="create_memberId"/>
            <input type="hidden" id="create_lokasiId"/>

            <?php echo $__env->make('admin.transaksi._step-lokasi',     ['prefix' => 'create'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('admin.transaksi._step-member',     ['prefix' => 'create', 'offset' => 1], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('admin.transaksi._step-masuk',      ['prefix' => 'create', 'offset' => 1], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('admin.transaksi._step-keluar',     ['prefix' => 'create', 'offset' => 1], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php echo $__env->make('admin.transaksi._step-konfirmasi', ['prefix' => 'create', 'offset' => 1], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
        ...
        <div class="flex items-center justify-between px-6 sm:px-8 py-4 border-t border-neutral-100 bg-neutral-50">
            ...
            <div class="ml-auto flex items-center gap-2">
                ...
                <button id="createBtnSimpan" onclick="simpanTransaksi()"
                        class="hidden text-sm font-medium px-4 py-2 rounded-lg bg-success-600 text-white hover:bg-success-700 transition-colors">
                    Simpan Transaksi
                </button>
            </div>
        </div>
    </div>
</div><?php /**PATH D:\Perkuliahan Duniawi\MAGANG GES\PerpusKotaYogyakarta\resources\views/admin/transaksi/create.blade.php ENDPATH**/ ?>