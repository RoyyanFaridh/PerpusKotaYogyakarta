<div id="modalHapusMember"
    ...
    <div class="relative z-10 w-full max-w-md rounded-2xl bg-white overflow-hidden shadow-xl">
        ...
        <div class="px-6 sm:px-8 pt-7 pb-6 flex flex-col items-center text-center gap-3">
            ...
            <div>
                <h2 class="text-base font-semibold text-neutral-800">Hapus Member?</h2>
                <p class="text-sm text-neutral-400 mt-1.5 leading-relaxed">
                    Member <span id="hapusMemberNama" class="font-semibold text-neutral-600"></span>
        ...
        <div class="flex items-center gap-2 px-6 sm:px-8 pb-6">
            <button type="button" onclick="tutupModalHapusMember()"
            ...
            <form id="formHapusMember" method="POST" action="" class="flex-1">
                <?php echo csrf_field(); ?>
...
<script>
    ...
    document.addEventListener('keydown', function (e) {
        if (e.key === 'Escape') tutupModalHapusMember();
    });
</script><?php /**PATH C:\xampp\htdocs\rotateyourbook\resources\views/admin/member/destroy.blade.php ENDPATH**/ ?>