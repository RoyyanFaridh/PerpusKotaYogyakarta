...
<head>
    ...
    <title>Login Admin – <?php echo e(config('app.name', 'SIROBY')); ?></title>
...
<body class="font-sans bg-primary-50 text-primary-900 min-h-screen overflow-x-hidden relative flex flex-col">
    ...
    <nav class="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-b border-primary-100 shadow-sm">
        <div class="w-full max-w-7xl mx-auto px-4 sm:px-8 h-16 flex items-center justify-between gap-4">
            <a href="<?php echo e(url('/')); ?>" class="flex items-center gap-2.5 no-underline shrink-0">
    ...
    <main class="relative z-10 flex-1 flex items-center justify-center pt-24 pb-12 px-4">
        ...
        <div class="w-full max-w-lg">
            ...
            <div class="anim-4 bg-white/90 backdrop-blur-lg rounded-2xl border border-primary-100 shadow-xl p-6 sm:p-10">
                <form action="<?php echo e(route('auth.login.post')); ?>" method="POST" class="space-y-5">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="flex flex-col gap-1.5">
                        ...
                        <div class="relative">
                            ...
                            <input
                                ...
                                class="w-full pl-10 pr-4 py-2.5 rounded-lg border text-sm text-primary-900 placeholder-neutral-300 transition-colors focus:outline-none focus:border-primary-400 focus:ring-2 focus:ring-primary-200 <?php echo e($errors->has('login') ? 'border-danger-400 bg-danger-50' : 'border-neutral-200 bg-white'); ?>"
                            >
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-1.5">
                        ...
                        <div class="relative">
                            ...
                            <input
                                ...
                                placeholder="••••••••"
                                class="w-full pl-10 pr-12 py-2.5 rounded-lg border text-sm text-primary-900 placeholder-neutral-300 transition-colors focus:outline-none focus:border-primary-400 focus:ring-2 focus:ring-primary-200 <?php echo e($errors->has('password') ? 'border-danger-400 bg-danger-50' : 'border-neutral-200 bg-white'); ?>"
                            >
            ...
            <p class="anim-5 text-center text-xs text-neutral-400 mt-6 leading-relaxed">
                ...
                <a href="<?php echo e(url('/')); ?>" class="text-primary-600 font-medium no-underline hover:underline">kembali ke beranda</a>.
            </p>
        </div>
    </main>

    <footer class="relative z-10 text-center px-4 py-5 text-xs text-neutral-400 border-t border-primary-100 bg-white">
        © <?php echo e(date('Y')); ?> SIROBY · Perpustakaan Kota Yogyakarta
    </footer>
...
</html><?php /**PATH D:\Perkuliahan Duniawi\MAGANG GES\PerpusKotaYogyakarta\resources\views/auth/login.blade.php ENDPATH**/ ?>