<div class="step-content-<?php echo e($prefix); ?> hidden" data-step="2">
    ...
    <div class="mb-5">
        ...
        <select id="<?php echo e($prefix); ?>_paketDiserahkanId"
    ...
    <div class="mb-4">
        ...
        <div class="flex gap-2">
            <div class="relative flex-1">
                ...
                <input type="text" id="<?php echo e($prefix); ?>_isbnDiserahkan"
            ...
            <button type="button" onclick="cariIsbnDiserahkan('<?php echo e($prefix); ?>')"
        ...
        <p id="<?php echo e($prefix); ?>_isbnDiserahkanInfo" class="text-xs text-neutral-400 mt-1.5"></p>
    </div>
    ...
    <div class="space-y-4">
        <div class="grid grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" id="<?php echo e($prefix); ?>_diserahkanJudul" placeholder="Judul buku"
            ...
            <div>
                ...
                <input type="text" id="<?php echo e($prefix); ?>_diserahkanPengarang" placeholder="Nama pengarang"
                       class="w-full px-3.5 py-2.5 text-sm rounded-lg border border-neutral-200 focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition"/>
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" id="<?php echo e($prefix); ?>_diserahkanPenerbit" placeholder="Nama penerbit"
                       class="w-full px-3.5 py-2.5 text-sm rounded-lg border border-neutral-200 focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition"/>
            </div>
            <div>
                <label class="block text-sm font-medium text-neutral-600 mb-1.5">
                ...
                <select id="<?php echo e($prefix); ?>_diserahkanKategori"
                        class="w-full px-3.5 py-2.5 text-sm rounded-lg border border-neutral-200 focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition bg-white">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                ...
                <input type="number" id="<?php echo e($prefix); ?>_diserahkanTahunTerbit"
            ...
            <div>
                ...
                <input type="text" id="<?php echo e($prefix); ?>_diserahkanTempatTerbit" placeholder="cth. Jakarta"
                       class="w-full px-3.5 py-2.5 text-sm rounded-lg border border-neutral-200 focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition"/>
            </div>
        </div>
        ...
        <div>
            ...
            <textarea id="<?php echo e($prefix); ?>_diserahkanDeskripsi" rows="2"
...
</div><?php /**PATH C:\xampp\htdocs\rotateyourbook\resources\views/admin/transaksi/_step-diserahkan.blade.php ENDPATH**/ ?>